...
const Landing = () => {
    ...
    return (
        <div className="w-full relative md:h-[80vh] h-auto md:mt-0 mt-16 md:flex-row flex-col flex items-center justify-center">
            <div className="bg-[#80007e83] blur-[90px] h-[6rem] w-[4rem] lg:h-[12rem] lg:w-[8rem] absolute top-[20%] left-[40%]" />
            <div className="flex flex-col md:w-[70%] w-full items-center gap-3">
                <div className="relative w-full flex flex-col md:items-start items-center md:gap-8 sm:gap-5 gap-4 ">
                    ...
                    <p className='md:text-start text-center capitalize text-[#475467]'>We help companies of all sizes, from start-ups to Fortune 500s - source, design, manufacture and import products from China with ease.</p>
            ...
            <div className=" md:w-2/3 w-full md:rotate-90 container mx-auto px-5 py-2 md:mt-0 mt-12">
